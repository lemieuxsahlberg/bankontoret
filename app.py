...
def simple_metrics(user_id):
    ...
    return {"piikki": piikki, "attempts_avg": attempts_avg, "pitkat": pitkat}
...
def render_history(user_id):
    ...
    for rnd in rounds:
        ...
        rows.append({
            ...
            "Ratoja": len(rhs),
            "Lyönnit yhteensä": total,
            "Väri": get_result_band(course.get("surface"), total)[0],
